    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/helpers").Include(
                    "~/Scripts/Helpers/ValidationCPFAttribute.js",
                    "~/Scripts/Helpers/VerificarExistenciaBeneficiario.js"));

            bundles.Add(new ScriptBundle("~/bundles/clientes").Include(
                      "~/Scripts/Clientes/FI.IncClientes.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/beneficiarios").Include(
                      "~/Scripts/Clientes/FI.IncBeneficiarios.js",           
                      "~/Scripts/Clientes/FI.AltBeneficiarios.js",
                      "~/Scripts/Clientes/FI.DelBeneficiarios.js"));
